...
ADMIN_EMAIL = 'jxaidjisisjs@byom.de'
...
def get_all_posts():
    ...
    return render_template("index.html", all_posts=posts, logged_in=current_user.is_authenticated, admin=admin_check())
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, admin=admin_check())
